...
|---------|-------------------|----------|-------------|------------------------|------------|
| **Substation 200MW** | `[0, 0, 100]` | `0°` | Aligné axes | **NORD** (centre horizontal, mur du fond) | 40m × 15m |
...
|---------|-------------------|------------------|-----------------|------------------|-------|
| **Substation 200MW** | `0°` | Aucune | `[0, 0, 100]` | `[0, 0, 100]` | Aligné avec les axes |
...
#### Substation 200MW
- **Position** : `[0, 0, 100]` (déplacée vers le mur du fond)
- **Rotation** : `0°`
...
1. **Substation** : Positionnée au NORD (Z=100) pour être éloignée des containers au SUD, vers le mur du fond
